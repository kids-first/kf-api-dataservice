...
class TestAPI:
    ...
    @pytest.mark.parametrize('endpoint,child_relations', [
        ...
        ('/sequencing-experiments', ['sequencing_experiment_genomic_files']),
        ('/diagnoses', ['biospecimen_diagnoses']),
        ('/cavatica-apps', ['tasks']),
        ('/tasks', ['task_genomic_files']),
    ])

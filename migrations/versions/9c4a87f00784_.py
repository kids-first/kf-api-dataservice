...
Revision ID: 9c4a87f00784
Revises: 
Create Date: 2018-02-22 11:38:33.868048
...
def upgrade():
    ...
    sa.Column('tumor_location', sa.Text(), nullable=True),
    ...
    sa.Column('sample_id', dataservice.api.common.model.KfId(length=11), nullable=False),
    sa.Column('kf_id', dataservice.api.common.model.KfId(length=11), nullable=False),
    ...
    sa.Column('aliquot_id', dataservice.api.common.model.KfId(length=11), nullable=False),
    sa.Column('kf_id', dataservice.api.common.model.KfId(length=11), nullable=False),
    ...
    sa.Column('md5sum', postgresql.UUID(), nullable=True),
    ...
    sa.Column('workflow_id', dataservice.api.common.model.KfId(length=11), nullable=False),
